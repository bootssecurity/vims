...
export function ConnectWalletButton({ className, customDropdownItems }: ConnectWalletButtonProps) {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger render={<Button className={cn("cursor-pointer group min-w-40 px-3", className)} />}><WalletIcon className="mr-1 h-4 w-4" />{formattedBalance}<AbstractLogo className="ml-1 h-4 w-4" /></DropdownMenuTrigger>
