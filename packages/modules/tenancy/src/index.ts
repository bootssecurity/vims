...
export function resolveTenantMode(hostname: string): {
  mode: TenantMode;
  label: string;
  description: string;
} {
  if (hostname.includes("admin")) {
    return {
      ...
      description:
        "Use a dedicated admin hostname for internal operations, support tooling, and cross-tenant controls.",
    };
  }
  ...
  return {
    ...
    description:
      "Resolve dealership branding, permissions, and website rendering from hostname or organization mapping.",
  };
}
